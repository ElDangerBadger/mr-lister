...
class PublicationErrorCode(StrEnum):
    ...
    INVALID_TRANSITION = "PUBLICATION_INVALID_TRANSITION"
    CALL_BUDGET_EXHAUSTED = "PUBLICATION_CALL_BUDGET_EXHAUSTED"
    DEADLINE_EXPIRED = "PUBLICATION_DEADLINE_EXPIRED"
    PERMIT_UNAVAILABLE = "PUBLICATION_PERMIT_UNAVAILABLE"
