...
The recent-preparations list can be hidden with one browser-local preference boolean; it stores no job data and never deletes application or provider records.
